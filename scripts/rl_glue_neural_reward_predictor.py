...
import neural_reward_predictor_dataset as nqd
import time
...
class NeuralQLearnAgent(Agent):
    ...
    def get_action(self):
        ...
        if self.counter != 4:
            ...
            action = self.get_action_valself.randGenerator.randint(0,self.num_actions-1))
       ...
       if len(self.data) > 7:
            ...
            reward_prediction = qvalues[0][self.get_val_action(action)]
            
            if reward_prediction >= .5:
                self.predicted_reward += 1
    ...
    def agent_end(self, reward):
        ...
        thefile.write(str(self.predicted_reward) + ", ")
